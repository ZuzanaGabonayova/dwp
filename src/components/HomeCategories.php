        ...
        <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
          <div class="group relative">
              ...
              <h3 class="mt-6 text-sm text-gray-500">
                <a href="../views/frontend/products_category_women.php" class="text-base font-semibold text-gray-900">
          ...
          <div class="group relative">
              ...
              <h3 class="mt-6 text-sm text-gray-500">
                <a href="../views/frontend/products_category_men.php" class="text-base font-semibold text-gray-900">
                  <span class="absolute inset-0"></span>
                  Men
                </a>
              </h3>
          ...
          <div class="group relative">
              ...
              <h3 class="mt-6 text-sm text-gray-500">
                <a href="../views/frontend/products_category_kids.php" class="text-base font-semibold text-gray-900">
                  <span class="absolute inset-0"></span>
                  Kids
                </a>
              </h3>
