...
// Function to display the admin's avatar
function displayAdminAvatar() {
    return '<div class="relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
        ...
        >
              ...
              <li>
                <ul role="list" class="-my-2 space-y-1">
                  ...
                  <li>
                   ...
                   <li>
                    <a href="<?php echo baseUrl(); ?>src/views/admin/users.php" class="flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50">
                      <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      fill="none" viewBox="0 0 24 24" 
                      stroke-width="1.5" 
          ...
          <div class="flex items-center mt-auto">
              ...
              <div>
                  ...
                  <a href="<?php echo baseUrl(); ?>src/admin_authentication/logout.php" class="text-xs text-gray-500 hover:text-gray-700">Logout</a>
              </div>
          </div>
