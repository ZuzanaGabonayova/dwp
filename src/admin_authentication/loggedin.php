...
function checkSessionTimeout() {
    ...
    if (isset($_SESSION['last_activity_time']) && (time() - $_SESSION['last_activity_time']) > $timeout) {
        ...
        header("Location: ../../src/views/admin/admin_login.php"); // Redirect to the login page
        exit();
    } else {
...
if (!isset($_SESSION['admin_username'])) {
    header("Location: ../../src/views/admin/admin_login.php"); // Redirect to the admin login page
    exit();
}
